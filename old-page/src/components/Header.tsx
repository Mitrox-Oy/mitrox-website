  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-center">
            <div className="glass rounded-full shadow-2xl px-8 py-4">
              <div className="flex items-center gap-8">
                ...
                <nav className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {/* Dropdown Menu */}
                    {productsOpen && (
                      <div className="absolute top-full left-0 mt-2 w-80 glass rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.35)] overflow-hidden z-50">
                        <div className="py-1">
                          <Link
      ...
      <MobileGlassNav
        ...
        affiliateHref={getFullLocalizedPath("affiliate", language)}
        open={open}
        setOpen={setOpen}
